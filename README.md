...
- можно создавать новую папку со всеми проектами - переменная `allprojects` в которую будет перенесён проект `allSources`/`sources`
...
- теперь например при написании `@img` будет работать поиск по `./allprojects/a/images` и ваводить подсказки с имеющимися файлами

### Обработка изображений
- исходные изображения в папке `allprojects/(название проекта)/src/images`
- настройки файле `gulp/config/setings.mjs`:
```
...
```
- сжатые изображения в папке `allprojects/(название проекта)/src/aa/img_min`
- созданные .webp и .avif в папке `allprojects/(название проекта)/src/aa/img` (переносятся в `allprojects/(название проекта)/dist/images`)
...
```
- готовый спрайт в папке `allprojects/(название проекта)/src/images/sprite/sprite` (переносятся в `allprojects/(название проекта)/dist/images/sprite`)
- инструкция для спрайта в папке `allprojects/(название проекта)/src/images/sprite/stack`
